...
const char* ssid     = "YOURHOMESSID";    //>>>>>>>>> CHANGE HERE
const char* password = "YOURWIFIOASSWORD";        //>>>>>>>>> CHANGE HERE
String DEVICEID   =    "YOUNAME01";            //>>>>>>>>> CHANGE HERE
#define mqtt_server    "52.117.240.201"    // NO change
