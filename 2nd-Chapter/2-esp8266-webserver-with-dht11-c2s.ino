//
// Simple WebServer - Displaying the DHT11 data on a webpages
//
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            ptr += ".humidity-text{font-weight: 600;padding-left: 60px;font-size: 19px;width: 160px;text-align: left;}\n";
            ptr += ".humidity{font-weight: 300;font-size: 60px;color: #3498db;}\n";
            ptr += ".temperature-icon{background-color: #f39c12;width: 30px;height: 30px;border-radius: 50%;line-height: 40px;}\n";
            ptr += ".temperature-text{font-weight: 600;padding-left: 60px;font-size: 19px;width: 160px;text-align: left;}\n";
            ...
            // client.println("<p>Humidity     = "+(String)h+"</p>");
             if (prevTemp == t)
                client.println("<div class=\"side-by-side temperature-text\">NO Temperature Change</div><br>");
            else
              client.println("<div class=\"side-by-side temperature-text\">Temperature Changed</div><br>");
